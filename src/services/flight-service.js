...
async function getFlight(id){
    try {
        ...
        if(error.statusCode === StatusCodes.NOT_FOUND){
            throw new AppError('The flight that you requested is not present',error.statusCode);
        }
        throw new AppError('Cannot fetch data of airplane',StatusCodes.INTERNAL_SERVER_ERROR);
    }
}
...
async function updateSeats(data){
    try {
        ...
        throw new AppError('Cannot update data of a flight',StatusCodes.INTERNAL_SERVER_ERROR);
    }
}
